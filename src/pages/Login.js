...
const AppLogin = () => {
  ...
  const handleEmailAuth = async (isSignUp) => {
    ...
    try {
      ...
      setMessage(`Error al ${isSignUp ? "registrarse" : "iniciar sesión"}: ${error.message}`);
    }
  };
        ...
        <div className={`container ${isRightPanelActive ? "right-panel-active" : ""}`}>
          <div className="form-container sign-in-container">
            <form>
              ...
              <div className="social-container">
                <a href="#" className="social" onClick={() => handleAuth(facebookProvider)}>
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="#" className="social" onClick={() => handleAuth(googleProvider)}>
              ...
              <button type="button" onClick={() => handleEmailAuth(false)}>Iniciar Sesión</button>
            </form>
          </div>
          ...
          <div className="form-container sign-up-container">
            <form>
              ...
              <button type="button" onClick={() => handleEmailAuth(true)}>Crear Cuenta</button>
            </form>
          </div>
          ...
          <div className="overlay-container">
            <div className="overlay">
              <div className="overlay-panel overlay-left">
                ...
                <button className="ghost" onClick={() => togglePanel(false)}>Iniciar Sesión</button>
              </div>
              <div className="overlay-panel overlay-right">
                <h1>¡Hola, Amigo!</h1>
                <p>Ingresa tus datos personales y comienza tu lista de tareas.</p>
                <button className="ghost" onClick={() => togglePanel(true)}>Crear Cuenta</button>
              </div>
            </div>
          </div>
        </div>
